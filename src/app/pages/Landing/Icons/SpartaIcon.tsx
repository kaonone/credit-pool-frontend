...
export function SpartaIcon(props: React.ComponentProps<typeof SvgIcon>) {
  const classes = useStyles();
  const theme = useTheme();

  const gradientStops = React.useMemo(
    () =>
      theme.gradients.spartaIcon.points.map(({ offset, color }, index) => (
  ...
  return (
    <SvgIcon {...props} classes={classes} viewBox="0 0 96 66">
      ...
      <defs key={hackForGradientUpdating}>
        <linearGradient id="SpartaIcon-gradient-a" x1="50%" x2="50%" y1="0%" y2="100%">
          {gradientStops}
        </linearGradient>
        <linearGradient id="SpartaIcon-gradient-b" x1="100%" x2="0%" y1="50%" y2="50%">
          {gradientStops}
        </linearGradient>
        <g id="SpartaIcon-shape">
          <path
            fill="url(#SpartaIcon-gradient-a)"
          ...
          />
          <path
            fill="url(#SpartaIcon-gradient-b)"
      ...
      <g fill="none" fillRule="evenodd">
        <use xlinkHref="#SpartaIcon-shape" />
        <use xlinkHref="#SpartaIcon-shape" />
      </g>
    </SvgIcon>
  );
